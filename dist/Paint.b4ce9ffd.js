...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"JSs/dragDropBox.js":[function(require,module,exports) {
"use strict";
...
function dragElement(elmnt) {
  var pos1 = 0,
      pos2 = 0,
      pos3 = 0,
      pos4 = 0; // move the DIV from anywhere inside the DIV:
...
},{}],"JSs/changePen.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = changePen;

function changePen() {
  var Brush = document.querySelector(".brush");
  var Highlighter = document.querySelector(".highlighter");
  var sprayCan = document.querySelector(".sprayCan");
  var Pencil = document.querySelector(".pencil");
  var changeBrush = document.querySelector(".sel_brush");
  var changeHighlighter = document.querySelector(".sel_highlighter");
  var changesprayCan = document.querySelector(".sel_sprayCan");
  var changePencil = document.querySelector(".sel_pencil");
  var paintScreen = document.querySelector("#paintScreen");
  var isPenSelected = document.querySelector("#pens");
  changeBrush.addEventListener("click", function (_) {
  ...
  changeHighlighter.addEventListener("click", function (_) {
    Pencil.style.opacity = 0;
    sprayCan.style.opacity = 0;
  ...
  changesprayCan.addEventListener("click", function (_) {
    Pencil.style.opacity = 0;
  ...
  changePencil.addEventListener("click", function (_) {
...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"JSs/navButtonAnim.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = navButtonAnim;

var _gsap = require("gsap");

function navButtonAnim() {
  // Define TimelineMax
  var tlm = new _gsap.TimelineMax({
    paused: true,
    reversed: true
  });
  ...
  var clickArea = document.querySelector(".navButton"); // Adding animations

  tlm.to(clickArea, 0.25, {
    rotation: 180
  }, "slide").to(lineOne, 0.25, {
    transformOrigin: "50% 50%",
    y: 5
  }, "slide").to(lineThree, 0.25, {
    transformOrigin: "50% 50%",
    y: -5
  }, "slide").to(lineTwo, 0.25, {
    scaleX: 0
  }, "slide").to(lineOne, 0.25, {
    transformOrigin: "50% 50%",
    rotation: 45
  }, "cross").to(lineThree, 0.25, {
    transformOrigin: "50% 50%",
    rotation: -45
  }, "cross"); // Initializing animations

  clickArea.addEventListener("click", function (_) {
    clickArea.classList.toggle("js_x");
    tlm.reversed() ? tlm.play() : tlm.reverse();
  });
}
},{"gsap":"node_modules/gsap/index.js"}],"JSs/navBarAnim.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = navBarAnim;
...
function navBarAnim() {
  ...
  var menuToggleButton = document.querySelector(".navButton");
  TLM.from(navBar, {
    scaleY: 0,
    transformOrigin: "top"
  }).to(navBar, 0.125, {
  ...
  menuToggleButton.addEventListener("click", function (_) {
...
},{"gsap":"node_modules/gsap/index.js"}],"JSs/changeCursor.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = changeCursor;

function changeCursor() {
  var pen = document.querySelector("#pens");
  var eraser = document.querySelector("#eraser");
  var paintScreen = document.querySelector("#paintScreen");
  var navToggleButton = document.querySelector(".navButton");
...
},{}],"JSs/toDraw.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = toDraw;

function toDraw() {
  var canvas = document.querySelector("#paintScreen");
  var draft = document.querySelector("#draft");
  var ctx = canvas.getContext("2d");
  var dctx = draft.getContext("2d");
  var isPenSelected = document.querySelector("#pens");
  var colorPicker = document.querySelector("#color-picker");
  var strokeWidth = document.querySelector("#stroke-width");
  ...
  var sprayCan = document.querySelector(".sprayCan");
  var Pencil = document.querySelector(".pencil");
  var eraseAll = document.querySelector("#eraseall");
  var eraser = document.querySelector("#eraser");
  var painting = false;
  var isErasing = false;
  var lastPoint;
  var points = [];
  selectColor(); // Resize canvas width and height on window resize
  ...
  resizeScreen(); // Mouse events

  canvas.addEventListener("mousedown", isPainting);
  canvas.addEventListener("mouseup", notPainting);
  canvas.addEventListener("mouseout", function (_) {
    window.addEventListener("mouseup", function (_) {
      painting = false;
      points.length = 0;
      if (canvas.classList.contains("eraserCursor")) isErasing = true;else isErasing = false;
  ...
  isPenSelected.addEventListener("click", function (_) {
    isPenSelected.classList.add("js_yes");
  });

  function draw(e) {
    if (!painting) return; // Erase
        ...
        ctx.moveTo(e.clientX + 8, e.clientY + 8);
      ...
      else if (isPenSelected.classList.contains("js_yes") && Pencil.classList.contains("js_active")) {
          ctx.globalAlpha = 1;
        ...
        } else if (isPenSelected.classList.contains("js_yes") && Brush.classList.contains("js_active")) {
          ctx.globalAlpha = 0.4;
        ...
        } else if (isPenSelected.classList.contains("js_yes") && sprayCan.classList.contains("js_active")) {
          ctx.globalAlpha = 1;
          draft.style.opacity = 1;
          ctx.globalCompositeOperation = "source-over";
          ctx.shadowBlur = 7;
          ...
          ctx.stroke();
        } else if (isPenSelected.classList.contains("js_yes") && Highlighter.classList.contains("js_active")) {
          ctx.globalAlpha = 1;
          draft.style.opacity = 1;
          ctx.globalCompositeOperation = "source-over";
          ctx.lineWidth = 3;
  ...
  function selectColor() {
    violet.addEventListener("click", function (_) {
      colorPicker.value = "#ee82ee";
    });
    blue.addEventListener("click", function (_) {
      colorPicker.value = "#5dcff5";
    });
    red.addEventListener("click", function (_) {
      colorPicker.value = "#f75858";
    });
    green.addEventListener("click", function (_) {
      colorPicker.value = "#76ff76";
    });
    yellow.addEventListener("click", function (_) {
      colorPicker.value = "#f8e326";
    });
  } // Erase All / Clear Board


  eraseAll.addEventListener("click", function (_) {
    ctx.clearRect(0, 0, canvas.width, canvas.height);
  });
}
},{}],"JSs/saveCanvas.js":[function(require,module,exports) {
"use strict";
...
function saveCanvas() {
  ...
  var disableCanvas = document.querySelector("#canvasDisable");
  var requiredMsg = document.querySelector(".reqmsg");
  var name = document.querySelector(".name");
  var Okay = document.querySelector("#submit");
  var body = document.querySelector("body");
  name.addEventListener("click", function (_) {
    if (requiredMsg.style.display == "block") {
      requiredMsg.classList.add("required");
    }
  });
  requiredMsg.addEventListener("click", function (_) {
    if (requiredMsg.style.display == "block") {
      requiredMsg.classList.add("required");
      name.focus();
    }
  });
  disableCanvas.addEventListener("click", function (_) {
    if (requiredMsg.style.display == "block") {
      requiredMsg.classList.remove("required");
      requiredMsg.style.display = "none";
    }
  });
  download.addEventListener("click", function (_) {
    name.focus(); // IE/Edge supports PNG only

    if (window.navigator.msSaveBlob) {
      window.navigator.msSaveBlob(canvas.msToBlob(), "canvas-image.png");
    } else {
      Okay.addEventListener("click", function (_) {
...
},{}],"JSs/inputBoxAnim.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = inputBoxAnim;

var _gsap = require("gsap");

function inputBoxAnim() {
  var tlm = new _gsap.TimelineMax({
    paused: true
  });
  var inputBox = document.querySelector("#image-name");
  var name = document.querySelector(".name");
...
},{"gsap":"node_modules/gsap/index.js"}],"JSs/Paint.js":[function(require,module,exports) {
"use strict";

var _dragDropBox = _interopRequireDefault(require("./dragDropBox"));

var _changePen = _interopRequireDefault(require("./changePen"));

var _navButtonAnim = _interopRequireDefault(require("./navButtonAnim"));

var _navBarAnim = _interopRequireDefault(require("./navBarAnim"));

var _changeCursor = _interopRequireDefault(require("./changeCursor"));

var _toDraw = _interopRequireDefault(require("./toDraw"));

var _saveCanvas = _interopRequireDefault(require("./saveCanvas"));

var _inputBoxAnim = _interopRequireDefault(require("./inputBoxAnim"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _dragDropBox.default)(document.getElementById("dropbox"));
(0, _changePen.default)();
(0, _navButtonAnim.default)();
(0, _navBarAnim.default)();
(0, _changeCursor.default)();
(0, _toDraw.default)();
(0, _saveCanvas.default)();
(0, _inputBoxAnim.default)();
},{"./dragDropBox":"JSs/dragDropBox.js","./changePen":"JSs/changePen.js","./navButtonAnim":"JSs/navButtonAnim.js","./navBarAnim":"JSs/navBarAnim.js","./changeCursor":"JSs/changeCursor.js","./toDraw":"JSs/toDraw.js","./saveCanvas":"JSs/saveCanvas.js","./inputBoxAnim":"JSs/inputBoxAnim.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "22437" + '/');
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","JSs/Paint.js"], null)
//# sourceMappingURL=/Paint.b4ce9ffd.js.map